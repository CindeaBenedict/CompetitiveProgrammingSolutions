...
public class Teleop extends LinearOpMode {
    ...
    public static double POSITION_UP_BLOCKER = 0.7;
    public static double POSITION_DOWN_BLOCKER = 0.41;

    public static double POSITION_UP_LATERAL = 0.3 ;
    public static double POSITION_DOWN_LATERLAL = 0.66 ;
    ...
    public void runOpMode() {
        ...
        in.setLateralPosition(POSITION_UP_LATERAL);
